...
function CertificateCard({ title, description, image, certificateURL }) {
  return (
    <a href={certificateURL} target='_blank' rel='noreferrer'>
      <div className='m-2 rounded-lg shadow-md h-full p-6 transform transition-all hover:scale-105 cursor-pointer dark:bg-blue-gray-800 dark:text-gray-300 bg-white'>
